...
This folder contains some useful scripts with basis Shell commands to  Some of the commands used in this scripts:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzMTk3MDE1Nyw3OTA3MjM1MzhdfQ==
-->